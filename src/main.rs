...
fn main() {
  let (mut graphics, mut event_loop) = CoreMaat::new("Boids2D".to_string(), (MAJOR) << 22 | (MINOR) << 12 | (PATCH), 1280.0, 1080.0, true);
  ...
  graphics.add_texture("boid".to_string(), "./resources/textures/boid_pixel.png".to_string());
